      ...
      <div className="w-full max-w-md bg-gray-900 rounded-lg p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4">
          <button
            ...
            className="flex-1 py-2 px-4 border border-gray-600 rounded text-white hover:bg-gray-800 transition-colors"
          >
            Cancelar
          </button>
          ...
          <button
            ...
            disabled={deleting}
            className="flex-1 py-2 px-4 bg-red-700 hover:bg-red-800 rounded text-white transition-colors"
          >
